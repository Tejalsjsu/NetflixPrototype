                        ...
                        <div className="col-sm-5">
                            ...
                            <div className="PagePayments-summary">
                                ...
                                <div className="PagePayments-summary-header">
                                    ...
                                    <div className="Payment-label padding-t10 block align-c padding-l30 text-black"> $75 </div>
                                </div>
                                <div className="PagePayments-summary-header">
                                    <div className="Payment-label padding-t10 padding-r10 text-blue">Outgoing :</div>
                                    <div className="Payment-label padding-t10 block align-c padding-l30 text-black">$25</div>
                                </div>
