...
class adminPlayMovie extends Component{
    ...
    handleSubmit = () => {
        API.registerConfirmation(this.state.token)
            .then((res) => {
                console.log(res)
                if (res.status === 200) {
    ...
    render(){
        ...
        return(
            <div style={divStyle3}>
                ...
                <Route exact path="/adminPlayMovie" render={() =>(
                    <div>
                        <div className="col-sm-2" style={divStyle2}> </div>
                        ...
                        <div style={divStyle1} className="col-sm-7">
                            ...
                            /> <br/><br/>
                            <a href="/adminAddMovie"><Button bsStyle="danger" bsSize="sm"
                                    > Go Back To Admin Page </Button></a>
