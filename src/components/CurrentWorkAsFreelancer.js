...
class CurrentWorkAsFreelancer extends Component {
    constructor(props){
        super(props);
    }
    ...
    componentWillMount(){
        ...
        //             this.props.history.push('/CurrentWorkAsFreelancer');
    ...
    render(){
        ...
        return(
            <div>
                        ...
                        <div className="container">
                            ...
                            <div className="text-left">
                                ...
                                <div className="dashboard_tab_wrapper">
                                    <div className="dashboard_tab"><NavLink to="/">Active Bids</NavLink></div>
                                <div className="dashboard_tab tab-clicked"> <NavLink to="/">Current Work</NavLink></div>
                                    <div className="dashboard_tab">
                                        <NavLink to="/PastWorkFreelancer">Past Work</NavLink> </div>
                                </div>
                ...
                <Route  path="/projectdetails/:projectId" render = {() => (
...
export default withRouter(CurrentWorkAsFreelancer);