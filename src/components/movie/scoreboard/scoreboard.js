...
class Scoreboard extends Component {
    ...
    render() {
        ...
        const withfilter =
            ...
            Object.keys(this.state.projectData.sort(compare))
                .map(pd => {
                return (
                    <tr
                ...
                <div className="container">
                    <div className="text-left">
                        ...
                        <div className="dashboard_tab_wrapper">
                            <div className="dashboard_tab  tab-clicked"> <NavLink to="/movieScoreboard">Highly Rated</NavLink></div>
                            <div className="dashboard_tab"><NavLink to="/ScoreboardByMostWatchedMovies">Most Watched</NavLink></div>
                        </div>
