...
class scoreboardByMostWatchedMovies extends Component {
        ...
        if (this.state.profileName != undefined) {
            ...
            API.fetchAllMovies(movie).then(res => {
                ...
                if (res.status === 200) {
                    ...
                    this.props.history.push("/scoreboardByMostWatchedMovies");
    ...
    render() {
        ...
        const withfilter =
            ...
            Object.keys(this.state.projectData)
                .map(pd => {
                    return (
                        <tr
                ...
                <div className="container">
                    <div className="text-left">
                        ...
                        <div className="dashboard_tab_wrapper">
                            <div className="dashboard_tab"> <NavLink to="/movieScoreboard">Highly Rated</NavLink></div>
                            <div className="dashboard_tab tab-clicked"><NavLink to="/ScoreboardByMostWatchedMovies">Most Watched</NavLink></div>
                        </div>
                    </div>
