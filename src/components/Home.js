    ...
    return(
        ...
        <Carousel>
            <Carousel.Item>
                ...
                <Carousel.Caption>
                    <a href="/login"><Button bsStyle="danger" bsSize="large"> Login </Button> </a> &nbsp;&nbsp;&nbsp;
                    <a href="/signup"><Button bsStyle="danger" bsSize="large"> Signup </Button> </a>
                    <h3>Netflix </h3>
            ...
            <div  className="col-sm-8">
                <h2> No Interested? </h2>
                   ...
                   <p> With secure payments and thousands of reviewed professional to choose from, Netflix.com is the simplest and safest way to get work done online.</p>
                <br/>
                <div align="left">
