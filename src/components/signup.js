...
class Signup extends Component {
  ...
  handleSubmit = () => {
    ...
    if (errors.length === 0) {
      ...
      axios
        .post(`${API.api}/userprofile`, signUpData)
        .then(result => {
          this.setState({
            isLoggedIn: true,
            message:
              "Account Created! An email verification link has been send. Kindly Verify your email and login!!"
          });
      ...
      //   API.saveData(signUpData).then(res => {
            ...
            <div>
              ...
              <div style={divStyle1} className="col-sm-3">
                ...
                <input
                  ...
                  value={this.state.userdata.profileName}
                  onChange={event => {
                    this.setState({
                      userdata: {
                        ...this.state.userdata,
                ...
                <div>
                  ...
                  <Link to="/login">Terms and Conditions</Link> and{" "}
