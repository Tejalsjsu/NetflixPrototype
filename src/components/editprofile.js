...
class EditProfile extends Component {
  ...
  handleSubmit = () => {
    ...
    if (this.state.userdata.phone.length === 0) {
      ...
      this.state.userdata.phone.length < 10 ||
      this.state.userdata.phone.length > 10
    ) {
        ...
        <Route
          ...
          render={() => (
            <div>
              <div className="container">
                <div>
                  ...
                  {this.state.validation_error && (
                    <div>
                      {this.state.validation_error.map((item, index) => (
                        <div
                          key={index}
                ...
                <div className="col-sm-4">
                  ...
                  <div className="text-left padding media-heading">
                    ...
                    <span>
                      ...
                      <h4 className="media-heading">
                        {" "}
                        Profile last updated : 04/14/2018
                      </h4>{" "}
                    </span>
                    <br />
                    <span>
                      {" "}
                      <h4 className="media-heading">Projects Posted : 5 </h4>
                    </span>
                    <br />
                    <span>
                      {" "}
                      <h4 className="media-heading">No of Bids : 8 </h4>
                    </span>
                    <br />
                  </div>
                </div>
                <div className="col-sm-6">
                  <div className="media-body text-left padd   ing">
                    ...
                    <textarea
                      ...
                      placeholder={this.state.proffesionHeading}
                      value={this.state.userdata.proffesionHeading}
                      maxLength={50}
                      rows={5}
                      onChange={event => {
                        this.setState({
                    ...
                    <div id="collapse1" className="panel-collapse collapse in">
                      <div className="panel-body">
                        <textarea
                          type="text"
                          className="form-control input-lg"
                          placeholder="Enter skills - e.g. Java, c, ReacrJS, etc "
              ...
              <br /> <br />
              <hr color="#E3E1E1" />
              <h3 className="font-grey">
                {" "}
                By clicking 'Post My Project', you agree to the Terms &
                Conditions and Privacy Policy
              </h3>{" "}
              <br /> <br /> <br />
              <h3 className="font-grey">
                Copyright © 2018 Freelancer Technology Pty Limited (ACN 142 189
                759)
              </h3>
            </div>
          )}
