                ...
                <Route exact path="/registrationConfirmation" render={() =>(
                    <div>
                        ...
                        <div style={divStyle1} className="col-sm-3">
                            ...
                            <input type="email" className="form-control" placeholder="Enter Token" value={this.state.token}
                                   onChange={(event) => {
                                       this.setState({
                            ...
                            <Button bsStyle="success" bsSize="sm" block
                                    onClick={() => this.handleSubmit(this.state.token)}> Confirm Email Token </Button>
