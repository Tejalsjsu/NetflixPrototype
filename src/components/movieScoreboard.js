...
class MovieScoreboard extends Component {
    constructor(props){
        super(props);
    }
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Route exact path="/movieScoreboard" render={() => (
                    <div>
                        <NavBar/>
                        <div >
                            <div className="container">
                                ...
                                <div className="text-left">
                                    <h1> Most popular and Highly rated Movies </h1> <br/> <br/>
...
export default withRouter(MovieScoreboard);